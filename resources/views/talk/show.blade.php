                    ...
                    <div
                        ...
                        <div class="border-b border-slate-50/[0.06] p-4">
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium text-sm">{{ date_format_my($talk->created_at->toDateString()) }}</span>
                            </div>
                        </div>
                        <div class="p-4">
                            {!! $talk->text !!}
...
{{--                            </p>--}}
                    ...
                    <div
                        class="flex rounded-lg backdrop-blur border border-slate-900/10 dark:border-slate-50/[0.06] bg-black/20 supports-backdrop-blur:bg-white/95 p-3 mb-3">
                        <img src="{{ asset('backgrounds/tf-graves.jpg') }}" class="h-16 w-16 mr-4" alt="sss">
                        <div class="flex flex-col flex-auto">
                            <div class="flex justify-between border-b border-slate-50/[0.06] mb-2">
                                <a class="text-lg" href="/user/1">
                                    Username
                    ...
                    <div
                        class="flex rounded-lg backdrop-blur border border-slate-900/10 dark:border-slate-50/[0.06] bg-black/20 supports-backdrop-blur:bg-white/95 p-3 mb-3">
                        <img src="{{ asset('backgrounds/star-guardians.jpg') }}" class="h-16 w-16 mr-4" alt="sss">
                        <div class="flex flex-col flex-auto">
                            <div class="flex justify-between border-b border-slate-50/[0.06] mb-2">
                                <a class="text-lg" href="/user/1">
                                    Username
                            ...
                            <div>
                                <p>Я считаю, что Лорем Ипсум устарел. Просто вдумайтесь: Lorem ipsum dolor sit amet,
                                    consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
                                    magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
                                    nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in
                                    voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
                                    cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est
                                    laboru. Нихрена же непонтяно...</p>
                            </div>
                        </div>
                    </div>
                    <div id="comment"
                         class="flex rounded-lg backdrop-blur border border-slate-900/10 dark:border-slate-50/[0.06] bg-black/20 supports-backdrop-blur:bg-white/95 p-3 mb-3">
                        <a class="text-2xl text-slate-400" href="{{ route('login') }}">Войди в аккаунт, чтобы оставить
                            комментарий</a>
                    </div>
                </div>
            </div>
